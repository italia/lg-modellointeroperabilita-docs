...
La comunicazione tra soggetti DEVE utilizzare modelli dati condivisi, in
...
L’adozione di modelli dati condivisi permette ai soggetti che
comunicano, di partire da una rappresentazione dei dati comune, evitando
la proliferazione di modelli dati differenti impattano direttamente
sulla modalità con cui i dati vengono resi persistenti. Ne consegue che
...
+-----------------------------------+-----------------------------------+
| (REG_SEMANTICA_001)               | Individuare i domini di interesse |
|                                   | e in essi determinare le entità   |
|                                   | da rappresentare in termini di    |
|                                   | proprietà che li caratterizzano.  |
+-----------------------------------+-----------------------------------+
| (REG_SEMANTICA_002)               | Verificare la presenza delle      |
|                                   | entità per dominio tra quelli     |
|                                   | definiti a livello nazionale da   |
|                                   | AgID [3]_.                        |
+-----------------------------------+-----------------------------------+
