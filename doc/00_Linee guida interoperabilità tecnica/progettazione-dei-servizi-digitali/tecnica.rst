...
-  la conformità ai pattern e/o profili di interoperabilità individuati dalla presente Linee Guida.
...
.. list-table:: 
   ...
   * - (REG_TECNICA_001)
     - Dare seguito all’analisi tecnica dei requisiti che, per ogni e-service, individui le caratteristiche funzionali o non funzionali per:

         * (REG_TECNICA_001.a) Selezionare la porzione del modello dati individuato nella fase semantica.
