...
X.509 Certificate Token Profile Versione 1.1.1 [OASIS wss-x509TokenProfile-v1.1.1-csprd01]_.
...
.. [1b] RFC 7519 - J. Bradley; N. Sakimura; M. Jones. `"JSON Web Token
   (JWT)" <https://tools.ietf.org/html/rfc7519>`__.

.. [2b] RFC 7515 - J. Bradley; N. Sakimura; M. Jones. `"JSON Web Signature
   (JWS)" <https://tools.ietf.org/html/rfc7515>`__.

.. [3b] ISO/IEC 13888-1:2009. "*Information technology - Security techniques
   - Non-repudiation - Part 1: General*". ISO/IEC, 2009

.. [OASIS wss-x509TokenProfile-v1.1.1-csprd01] OASIS wss-x509TokenProfile-v1.1.1-csprd01 - A. Nadalin; C. Kaler; R.
...
.. [5b] RFC 5246 - T. Dierks; E. Rescorla - “\ `The Transport Layer Security
   (TLS) Protocol Version
   1.2 <https://www.ietf.org/rfc/rfc5246.txt>`__\ ”

.. [6b] RFC 8446 - E. Rescorla - “\ `The Transport Layer Security (TLS)
   Protocol Version 1.3 <https://tools.ietf.org/html/rfc8446>`__\ ”

.. [7b] RFC 2119 - S. Bradner - “\ `Key words for use in RFCs to Indicate
   Requirement Levels <https://www.ietf.org/rfc/rfc2119.txt>`__\ ”

.. [8b] RFC 3553 - E. Rescorla, et al. - “\ `Guidelines for Writing RFC Text
   on Security
